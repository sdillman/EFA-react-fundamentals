...
// function to fetch the associated Star Wars character from the Star Wars API
  const fetcher = () => {
  ...
  return(
    ...
    <div className="mainDiv">
      ...
      {/* See a result - 'results' comes from the useState above */}
...
const useNumHook = (num) => {
  ...
  useEffect(() => {
    // using an Effect because a fetch is a side-effect - does not directly affect the DOM
    if (queryNum !== ''){
